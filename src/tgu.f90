...
!----------------------------------------------------------------------!
open (20,file='/home/adf10/grow_up_0/data/output.txt')
!----------------------------------------------------------------------!
...
do kyr = 1, nyr
  ...
  do it = 1, ntimes
    ...
    ! Taken from Crous et al. (2022), Eqn. 4.
    !------------------------------------------------------------------!
    fT_R = Q10_R ** ((TC - 20.0) / 10.0)
    !------------------------------------------------------------------!
    ! Gross photosynthesis                    (mol[CO2] m[ground]-2 s-1)
    !------------------------------------------------------------------!
    Ag_crown_mol = fi_Su * 5.0e-6
    !------------------------------------------------------------------!
    ! Crown respiration                       (mol[CO2] m[ground]-2 s-1)
    !------------------------------------------------------------------!
    R_crown_mol = fi_Su * 1.0e-6
    !------------------------------------------------------------------!
    ...
    Mtot_nhw = Mfol + Ma_sw + Mb_sw + Mfro
    !------------------------------------------------------------------!
    ! Sucrose fraction of non-heartwood biomass               (fraction)
    !------------------------------------------------------------------!
    fSu = Su / (Mtot_nhw + eps)
    !------------------------------------------------------------------!
